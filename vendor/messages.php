        ...
        <div class="col-lg-3">
            <div class="sidebar-nav">
                ...
                <a href="messages.php" class="active"><i class="fas fa-comments fa-fw me-2"></i>Messages (Admin)
                    <?php
                    $ucAdmin = (int)$conn->query("SELECT COUNT(*) as c FROM messages WHERE receiver_id=$uid AND sender_id=$admin_id AND is_read=0")->fetch_assoc()['c'];
                    if ($ucAdmin > 0): ?>
                    <span class="badge bg-danger ms-auto"><?= $ucAdmin ?></span>
                    <?php endif; ?>
                </a>
                <a href="officer_chat.php"><i class="fas fa-user-shield fa-fw me-2"></i>Message Officers
